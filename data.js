...
const db = {
    ...
    characters: [
        {
            ...
            special_rules: ["Psychoteric choir", "Peut gagner le type wyrd et choisir un Pouvoir psychoteric wyrd pour +35 crédits."],
        ...
        },
        {
            ...
            starting_xp: 49,
            starting_skill: "From the shadows et 1 au choix dans les primaires",
            special_rules: ["Psychoteric choir"],
        ...
        },
        {
            ...
            special_rules: ["Psychoteric choir", "lourd (Bulging biceps), artilleur (Hip-shooting), pistolero (Gunfighter), scout (Clamber), sniper (Precision shot), bagarreur (Berserker), medic (Medicate), tech (Munitioneer)"],
            primary_skills: ["ruse"],
        ...
        },
        {
            ...
            starting_xp: 4,
            starting_skill: "Un parmi les psychoteric wyrd",
            special_rules: ["Psychoteric choir", "Peut choisir un pouvoir psychoteric wyrd dès le départ"],
            primary_skills: ["ruse", "psychoteric wyrd"],
            secondary_skills: ["agilité"],
            cost: 30,
            tactics_cards: 0,
            is_wyrd: true
        ...
        },
        {
            ...
            starting_xp: 25,
            starting_skill: "Juggernaut",
            special_rules: ["Psychoteric choir", "Peut choisir un pouvoir psychoteric wyrd dès le départ. Est directement équipé de psychomantic claws. Ne peut jamais acheter d'arme ou d'équipement."],
            primary_skills: ["muscle", "psychoteric wyrd"],
            secondary_skills: ["combat"],
            cost: 250,
            tactics_cards: 0,
            default_weapons: ["wpn_psychomantic_claws"],
            cannot_buy_gear: true,
            is_wyrd: true
        },
        {
            ...
            starting_xp: 13,
            starting_skill: "Leash de 3\", Sensor array",
            special_rules: ["Psychoteric choir", "Sensor array", "Armé de base de shock tendrils. Ne peut jamais acheter d'arme ou d'équipement."],
            primary_skills: ["ruse"],
            secondary_skills: ["agilité"],
            cost: 75,
            tactics_cards: 0,
        ...
        },
        {
            ...
            starting_xp: 13,
            starting_skill: "Leash de 12\", Psychoteric node, Burrowing",
            special_rules: ["Psychoteric choir", "Psychoteric node", "Burrowing", "Armé de base de ferocious jaws. Ne peut jamais acheter d'arme ou d'équipement."],
        ...
        },
        {
            ...
            type: ["Guerrier", "brute"], starting_xp: 25, starting_skill: "Infiltrate, Juggernaut", primary_skills: ["Muscle"], secondary_skills: ["Combat"], cost: 230,
        ...
        },
        {
            ...
            type: ["Guerrier", "brute"], starting_xp: 25, starting_skill: "Headbutt, Juggernaut", primary_skills: ["Muscle"], secondary_skills: ["Combat"], cost: 160,
    ...
    skills: {
        ...
        "psychoteric wyrd": [
            { id: "sk_psychotic_lure", name: "Psychotic Lure", desc: "(Action simple) : Choisis un ennemi en ligne de vue dans les 6\" avec un marqueur prêt. Il devra être obligatoirement activé au prochain tour de l'adversaire et ne pourras pas faire d'activation de groupe." },
            ...
            { id: "sk_cacophony_of_silence", name: "Cacophony of silence", desc: "(Action simple) : Effet continu : quand cet effet est maintenu, tous les ennemis en ligne de vue dans les 6\" doivent relancer leur jets réussis pour toucher au tir." },
            { id: "sk_a_perfect_void", name: "A perfect void", desc: "(Action gratuite) : Effet continu : Tant que ce pouvoir est maintenu, le wyrd compte comme étant toujours à couvert et à portée longue des armes de tir de tous les ennemis dans les 10\"." },
        ...
        generique: [
            { id: "sk_psychoteric_choir", name: "Psychoteric choir", desc: "Quand un guerrier Delaque se trouve à 3\" ou moins de deux ou plus alliés Delaque, leur Ld et leur Will augmentent de 1." },
            { id: "sk_from_the_shadows", name: "From the shadows", desc: "Au lieu de déployer ce guerrier normalement, il peut être gardé de côté. Au début de n'importe quel round après le premier, avant le jet de priorité, il peut être déployé n'importe où sur le terrain, hors de ligne de vue et à plus de 9\" de tout ennemi.", specific_to: "char_nacht_ghul" },
            { id: "sk_sensor_array", name: "Sensor array", desc: "Si le Cephalopod Spektor est dans la distance de leash de son maitre quand celui-ci fait un test d'Int, celui-ci lance un dé de plus et garde le meilleur.", specific_to: "char_cephalopod_spektor" },
            { id: "sk_psychoteric_node", name: "Psychoteric node", desc: "Quand son maitre utilise un pouvoir psychoteric wyrd en étant à portée de leash, il peut lancer son pouvoir depuis le psychoteric wyrm.", specific_to: "char_psychoteric_wyrm" },
            { id: "sk_burrowing", name: "Burrowing", desc: "Peut se déplacer sous les terrains infranchissables.", specific_to: "char_psychoteric_wyrm" },
    ...
    // ===== ARMES =====
    weapons: [
        // Armes de base et communes Delaque
        ...
        { id: "wpn_autopistol", name: "Autopistol", profiles: [{ name: "Unique", SR: '8"', LR: '12"', S: 3, AP: "-", L: 1, traits: "Léger, tir rapide (1)" }], cost_credits: 10, cost_tp: 0, is_gang_weapon: true, is_hive_scum: true },
        ...
        { id: "wpn_multifuseur", name: "Muti fuseur*", profiles: [{ name: "Unique", SR: '12"', LR: '24"', S: 8, AP: "-4", L: 3, traits: "Munitions (6+), dommages (3), lourd" }], cost_credits: 150, cost_tp: 4, is_gang_weapon: false, is_hive_scum: false },
        ...
        { id: "wpn_grenade_explo", name: "Grenade explosive", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '6"', S: 5, AP: "-1", L: 2, traits: "Munitions (5+), explosion (5\"), knockback (5+), limité" }], cost_credits: 60, cost_tp: 2, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_gaz", name: "Grenade à gaz asphyxiant", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: "-", AP: "-", L: 1, traits: "Munitions (5+), explosion (3\"), gaz, limité, toxine (3+)" }], cost_credits: 45, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_charge_demo", name: "Charge de démolition", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '6"', S: 6, AP: "-3", L: 3, traits: "Munitions (6+), explosion (5\"), dommages (2), limité" }], cost_credits: 85, cost_tp: 3, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_frag", name: "Grenades frag", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: 3, AP: "-", L: 1, traits: "Munitions (4+), explosion (3\"), knockback (6+), limité" }], cost_credits: 30, cost_tp: 0, is_gang_weapon: false, is_hive_scum: true, counts_as_equip: true },
        { id: "wpn_grenade_inc", name: "Grenades incendiaires", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: 3, AP: "-", L: 1, traits: "Munitions (5+), explosion (5\"), flammes (5+), limité" }], cost_credits: 40, cost_tp: 2, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_krak", name: "Grenades krak", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: 6, AP: "-2", L: 1, traits: "Munitions (4+), limité" }], cost_credits: 45, cost_tp: 1, is_gang_weapon: false, is_hive_scum: true, counts_as_equip: true },
        { id: "wpn_grenade_phos", name: "Grenades à phosphore", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: 4, AP: "-2", L: 2, traits: "Munitions (5+), explosion (3\"), flammes (5+), limité, instable" }], cost_credits: 65, cost_tp: 3, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_photon", name: "Grenades à photon", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: "-", AP: "-", L: "-", traits: "Munitions (4+), explosion (5\"), flash, limité" }], cost_credits: 15, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_plasma", name: "Grenades à plasma", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: 5, AP: "-1", L: 2, traits: "Munitions (4+), explosions (3\"), Dommages (2), limité, instable" }], cost_credits: 70, cost_tp: 3, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_rad", name: "Grenades rad", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: 2, AP: "-1", L: 1, traits: "Munitions (4+), explosion (3\"), limité, rad-phage" }], cost_credits: 25, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false, counts_as_equip: true },
        { id: "wpn_grenade_fumi", name: "Grenades fumigène", type: "Grenade", profiles: [{ name: "Unique", SR: "-", LR: '9"', S: "-", AP: "-", L: "-", traits: "Munitions (4+), explosion (3\"), limité, fumée" }], cost_credits: 15, cost_tp: 0, is_gang_weapon: true, is_hive_scum: true, counts_as_equip: true },
        ...
        { id: "wpn_hache_nrj", name: "Hache énergétique", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-3", L: 1, traits: "Brêche (5+), melee" }], cost_credits: 40, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false },
        { id: "wpn_gantelet_nrj", name: "Gantelet énergétique", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S+3", AP: "-3", L: 2, traits: "Brêche (6+), Commotion (5+), dommages (2), Melee, encombrant" }], cost_credits: 105, cost_tp: 3, is_gang_weapon: false, is_hive_scum: false },
        { id: "wpn_marteau_nrj", name: "Marteau énergétique", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-2", L: 2, traits: "Brêche (6+), Commotion (6+), melee" }], cost_credits: 40, cost_tp: 2, is_gang_weapon: false, is_hive_scum: false },
        { id: "wpn_couteau_nrj", name: "Couteau énergétique", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-2", L: 1, traits: "Backstab, Brêche (6+), melee" }], cost_credits: 30, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false },
        { id: "wpn_masse_nrj", name: "Masse énergétique", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S+1", AP: "-2", L: 1, traits: "Brêche (6+), commotion (6+), melee" }], cost_credits: 45, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false },
        { id: "wpn_epee_nrj", name: "Epée énergétique", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-2", L: 1, traits: "Brêche (6+), melee, parade" }], cost_credits: 40, cost_tp: 2, is_gang_weapon: false, is_hive_scum: false },
        ...
        { id: "wpn_couteau_combat", name: "Couteau de combat", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-", L: 1, traits: "Backstab, melee" }], cost_credits: 5, cost_tp: 0, is_gang_weapon: false, is_hive_scum: true },
        ...
        { id: "wpn_marteau_2m", name: "Marteau à deux mains*", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S-1", AP: "-", L: 3, traits: "Commotion (6+), Lourd, melee, encombrant" }], cost_credits: 40, cost_tp: 1, is_gang_weapon: false, is_hive_scum: true },
        ...
        { id: "wpn_shock_baton", name: "Shock baton", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-", L: 1, traits: "Melee, parade, shock (6+)" }], cost_credits: 20, cost_tp: 1, is_gang_weapon: true, is_hive_scum: false },
        ...
        { id: "wpn_fouet_shock", name: "Fouet shock", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S", AP: "-", L: 1, traits: "Knockback (6+), melee, shock (6+)" }], cost_credits: 10, cost_tp: 1, is_gang_weapon: false, is_hive_scum: false },
        ...
        // Armes Associées Delaque (Strictement restreintes aux figurines indiquées)
        { id: "wpn_psychomantic_claws", name: "Psychomantic claws", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S+1", AP: "-3", L: 1, traits: "Melee, paire (2)" }], cost_credits: 65, cost_tp: 0, is_gang_weapon: true, is_hive_scum: false, associated_fighter: "Psy-Gheist et Piscean Spektor", associated_to: ["char_psy_gheist", "char_piscean_spektor"] },
        { id: "wpn_serpents_fangs", name: "Sperpent's fangs", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "-", AP: "-3", L: 1, traits: "Melee, paire (2), toxine (3+)" }], cost_credits: 70, cost_tp: 0, is_gang_weapon: true, is_hive_scum: false, associated_fighter: "Nacht-Ghul", associated_to: ["char_nacht_ghul"] },
        { id: "wpn_shivver_sword", name: "Shivver sword", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S+1", AP: "-1", L: 2, traits: "Melee, parade" }], cost_credits: 50, cost_tp: 0, is_gang_weapon: false, is_hive_scum: false, associated_fighter: "Nacht-Ghul", associated_to: ["char_nacht_ghul"] },
        { id: "wpn_ferocious_jaws", name: "Ferocious jaws", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S+1", AP: "-1", L: 1, traits: "Melee, déchirant (6+)" }], cost_credits: 0, cost_tp: 0, is_gang_weapon: true, is_hive_scum: false, associated_fighter: "Psychoteric wyrm", associated_to: ["char_psychoteric_wyrm"], default_for: "char_psychoteric_wyrm" },
        { id: "wpn_shock_tendrils", name: "Shock Tendrils", profiles: [{ name: "Unique", SR: "E", LR: "-", S: "S+1", AP: "-", L: 1, traits: "Melee, shock (6+)" }], cost_credits: 0, cost_tp: 0, is_gang_weapon: true, is_hive_scum: false, associated_fighter: "Cephalopod spektor", associated_to: ["char_cephalopod_spektor"], default_for: "char_cephalopod_spektor" },
    ...
    equipment: [
        // --- Armures ---
        { id: "eq_armure_cara_leg", name: "Armure carapace légère", type: "Armure", cost_credits: 100, cost_tp: 1, effect: "Améliore la sauvegarde de 1. Réduit l'initative de 1.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_armure_cara_lourde", name: "Armure carapace lourde", type: "Armure", cost_credits: 140, cost_tp: 3, effect: "Améliore la sauvegarde de 2. Réduit l'initiative de 2. Applique un malus aux jets d'agilité de -1.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_hazard_suit", name: "Hazard suit", type: "Armure", cost_credits: 10, cost_tp: 0, effect: "Le porteur est immunisé aux traits flammes (X+) et rad-phage.", is_gang: false, is_gang_weapon: false, is_hive_scum: true },
        { id: "eq_mesh_armour", name: "Mesh Armour", type: "Armure", cost_credits: 40, cost_tp: 0, effect: "Améliore la sauvegarde de 1 au corps à corps.", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        { id: "eq_reflec_shroud", name: "Reflec shroud", type: "Armure", cost_credits: 25, cost_tp: 1, effect: "Le porteur considère que l'Ap des armes las, plasma et fuseur est \"-\"", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_refractor_shield", name: "Refractor shield", type: "Armure", cost_credits: 50, cost_tp: 2, effect: "Donne une sauvegarde invulnérable de 5+. Au premier jet de sauvegarde de 1, le champ ne fonctionne plus. Peut être combiné avec les autres armures.", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        
        // --- Équipement personnel ---
        { id: "eq_bio_booster", name: "Bio-booster", type: "Personnel", cost_credits: 25, cost_tp: 0, effect: "La première fois que ce guerrier est blessé, réduisez la léthalité de 1.Si elle tombe à zéro, jetez deux dés et choisissez lequel garder.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_drop_rig", name: "Drop rig", type: "Personnel", cost_credits: 10, cost_tp: 0, effect: "Un guerrier actif ou suppressed peut faire l'action descendre s'il est à 1\" d'un rebord : Il peut bouger jusqu'à 12\" verticalement vers le bas et jusqu'à 3\" horizontalement.", is_gang: false, is_gang_weapon: false, is_hive_scum: true },
        { id: "eq_grapnel_launcher", name: "Grapnel launcher", type: "Personnel", cost_credits: 25, cost_tp: 0, effect: "Le guerrier peut faire l'action grappin : il peut se déplacer de 12\" en ligne droite dans n'importe quelle direction, à condition de finir plus haut qu'au départ.", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        { id: "eq_grav_chute", name: "Grav Chute", type: "Personnel", cost_credits: 30, cost_tp: 0, effect: "Quand un guerrier avec cet équipement tombe ou saute vers le bas, il ne subit jamais de dommages et n'est jamais suppressed.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_kit_medical", name: "Medicae Kit", type: "Personnel", cost_credits: 20, cost_tp: 0, effect: "Un guerrier avec cet équipement qui soigne un allié pendant un test de recovery jette 2 dés et garde celui de son choix", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        { id: "eq_photo_googles", name: "Photo-googles", type: "Personnel", cost_credits: 35, cost_tp: 0, effect: "La visibilité (X+) de ce guerrier augmente de 9\" et il peut voir voir à travers la fumée. S'il est touché par une munition flash, il a un malus de -2 à son test d'initiative.", is_gang: true, is_gang_weapon: true, is_hive_scum: true },
        { id: "eq_photo_lumens", name: "Photo-Lumens", type: "Personnel", cost_credits: 15, cost_tp: 0, effect: "La visibilité (X+) de ce guerrier augmente de 9\" mais il peut toujours être pris pour cible, quelle que soit la valeur de la règle luminosité (X+)", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_respirator", name: "Respirator", type: "Personnel", cost_credits: 15, cost_tp: 0, effect: "Un guerrier avec cet équipement beneficie d'une sauvegarde à 5+ invulnérable contre les armes avec le trait gaz", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        { id: "eq_servo_harness_partial", name: "Servo-harness partial", type: "Personnel", cost_credits: 100, cost_tp: 2, effect: "Le guerrier obtient +2 en force et et +1 en endurance. Cela peut l'amener à dépasser le maximum autorisé. Il a un malus en mouvement et initiative de -1. Ne peut être combiné avecune servo-griffe ou un servo-harnais total.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_servo_harness_full", name: "Servo-harness full", type: "Personnel", cost_credits: 130, cost_tp: 3, effect: "Le guerrier obtient tous les bénéfices du servo-harnais partiel, sans les malus. Ne peut être combiné avec une servo griffe ou un servo-harnais partiel.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_stimm_slug_stash", name: "Stimm-slug stash", type: "Personnel", cost_credits: 25, cost_tp: 0, effect: "Une fois par bataille, le guerrier peut l'utiliser au début de son activation. Jusqu'à sa prochaine activation, il gagne +2 en M, S et T. A leur prochaine activation, on lance un D6. Sur 2+, aucun effet. Sur un 1, il prend une blessure.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_dirt_bike", name: "Dirt bike", type: "Personnel", cost_credits: 35, cost_tp: 0, effect: "Le guerrier obtient le type monté. Son M passe à 8\" et quand il effectue l'action dash, il se déplace de 5\" plutôt que de son initiative.", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        { id: "eq_psychomancers_harness", name: "Psychomancer's harness", type: "Personnel", cost_credits: 35, cost_tp: 0, effect: "Augmente le M de 2\". Grimper à la verticale ne divise pas le mouvement par 2.", is_gang: true, is_gang_weapon: true, is_hive_scum: false },
        
        // --- Équipement Mercenaire intact ---
        ...
        // --- Accessoires d'arme ---
        { id: "eq_focusing_cristal", name: "Focusing cristal", type: "Accessoire", cost_credits: 25, cost_tp: 1, effect: "Augmente l'AP de 1. L'arme devient instable.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_hotshot", name: "Hotshot las pack", type: "Accessoire", cost_credits: 25, cost_tp: 1, effect: "Augmente la force de l'arme de 1", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_infra_sight", name: "Infra-sight", type: "Accessoire", cost_credits: 10, cost_tp: 0, effect: "Permet de tirer sur une cible à travers de la fumée. Augmente la visbilité (X\") de 9\".", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_las_projector", name: "Las-projector", type: "Accessoire", cost_credits: 20, cost_tp: 1, effect: "Réduit le bonus de couvert de 1 à portée courte.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_mono_sight", name: "Mono-sight", type: "Accessoire", cost_credits: 20, cost_tp: 0, effect: "Quand le guerrier réalise une action de aimed shot, augmente le bonus de +2 au lieu de +1", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_suspensors", name: "Suspensors", type: "Accessoire", cost_credits: 40, cost_tp: 0, effect: "Seulement pour les armes avec un * . L'arme ne compte que pour une pour le nombre d'arme que peut porter le guerrier, au lieu de 2.", is_gang: false, is_gang_weapon: false, is_hive_scum: false },
        { id: "eq_telescopic_sight", name: "Telescopic sight", type: "Accessoire", cost_credits: 20, cost_tp: 1, effect: "Réduit le bonus de couvert de 1 sur la portée longue.", is_gang: true, is_gang_weapon: true, is_hive_scum: true }
    ],
